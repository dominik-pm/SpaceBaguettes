...
var metall_crates = null
var obstacles
onready var _half_cell_size = cell_size / 2

func _ready():
	game = get_parent().get_parent()
	map_size = Vector2(game.map_size_x, game.map_size_y)
...
func get_metalls():
	if metall_crates == null:
		return get_used_cells_by_id(1)
	else:
		return metall_crates
...
func find_path_local(coord_start, coord_end):
	init_cells()
	
	self.path_start_position = coord_start
...
func _draw():
	...
	set_cell(point_end.x, point_end.y, 3)
